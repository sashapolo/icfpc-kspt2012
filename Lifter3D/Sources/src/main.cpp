...
int main()
{
    ...
    scene::ISceneNode* skybox=smgr->addSkyBoxSceneNode(
                driver->getTexture("res/textures/sky/irrlicht2_up.jpg"),
                driver->getTexture("res/textures/sky/irrlicht2_dn.jpg"),
                driver->getTexture("res/textures/sky/irrlicht2_lf.jpg"),
                driver->getTexture("res/textures/sky/irrlicht2_rt.jpg"),
                driver->getTexture("res/textures/sky/irrlicht2_ft.jpg"),
                driver->getTexture("res/textures/sky/irrlicht2_bk.jpg"));
    driver->setTextureCreationFlag(video::ETCF_CREATE_MIP_MAPS, true);

    IGUISkin* skin = guienv->getSkin();
    IGUIFont* font = guienv->getFont("./res/fonts/fontlucida.png");
    if (font)
            skin->setFont(font);
